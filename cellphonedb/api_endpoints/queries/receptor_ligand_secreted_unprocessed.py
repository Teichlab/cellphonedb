...
#     http://127.0.0.1:5000/api/receptor_ligand_secreted_unprocessed


class ReceptorLigandSecretedUnprocessed(EndpointBase):
    def post(self):
        ...
        if not self._errors:
            ...
            result_interactions, result_interactions_extended = extensions.cellphonedb_flask.cellphonedb.query.receptor_ligand_secreted_interactions(
