...
class TestQueryUtils(TestCase):
    ...
    def test_apply_threshold(self):
        cluster_counts = pd.read_csv('{}/query_utils_generic_cluster_counts.csv'.format(self.FIXTURES_UTILS_PATH))
    ...
    def test_filter_empty_cluster_counts(self):
        ...
        expected_result = pd.read_csv(
            '{}/query_utils_filter_empty_cluster_results.csv'.format(self.FIXTURES_UTILS_PATH))
        ...
        result = query_utils.filter_empty_cluster_counts(cluster_counts, cluster_names)
