...
from cellphonedb.core.models.interaction.filter_interaction import filter_by_receptor_ligand_secreted
...
def _get_enabled_interactions(cluster_counts: pd.DataFrame, interactions: pd.DataFrame,
                              min_score_2: float) -> pd.DataFrame:
    enabled_interactions = filter_by_receptor_ligand_secreted(cluster_counts, interactions)
