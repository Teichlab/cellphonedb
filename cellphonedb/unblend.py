...
class Unblend:
    ...
    @staticmethod
    def multidata(original_df, columns_to_merge, result_name_base, multidatas, remove_original=False):
        ...
        for index in range(len(columns_to_merge)):
            result = Unblend.unblend_column(result, columns_to_merge[index], multidatas, 'multidata',
                                            target_name_column,
