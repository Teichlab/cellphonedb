...
class TestHumanInteractionsPermutations(CellphoneFlaskTestCase):
    ...
    def test_real_data(self):
        ...
        self.query_call(data, interactions, iterations)
    ...
    def query_call(self, data, interactions, iterations):
        means_base_name = 'r_m_means__data-{}_it-{}_in-{}'.format(data, iterations, interactions)
        pvalues_base_name = 'r_m_pvalues__data-{}_it-{}_in-{}'.format(data, iterations, interactions)
        ...
        FlaskTerminalQueryLauncher().human_interactions_permutations(
            meta_namefile, counts_namefile, '10', data_test_dir, output_test_dir, result_means_namefile,
            result_pvalues_namefile, '0', '10', '1')

        means_test_namefile = 'hi_r_m_means__data-{}_it-{}_in-{}.txt'.format(data, iterations, interactions)
        ...
        pvalues_test_namefile = 'hi_r_m_pvalues__data-{}_it-{}_in-{}.txt'.format(data, iterations, interactions)
